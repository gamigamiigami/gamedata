const wordData = [
  ...
  // 乗法（3数以上）
  // ==================
  { expr: "(−1)×(−2)×3",           type: "正", category: "乗法" },
  { expr: "2×(−3)×(−2)",           type: "正", category: "乗法" },
  { expr: "(−1)×(−1)×4",           type: "正", category: "乗法" },
  { expr: "(−3)×2×(−2)",           type: "正", category: "乗法" },
  { expr: "(−2)×(−2)×(−1)×(−1)",  type: "正", category: "乗法" },
  { expr: "(−1)×(−1)×(−1)×(−1)",  type: "正", category: "乗法" },
  { expr: "(−1)×(−3)×2×(−1)×(−1)",type: "正", category: "乗法" },
  { expr: "3×(−2)×(−1)",           type: "正", category: "乗法" },

  { expr: "(−2)×(−3)×(−2)",        type: "負", category: "乗法" },
  { expr: "(−1)×2×(−3)×(−1)",      type: "負", category: "乗法" },
  { expr: "(−1)×(−1)×(−1)",        type: "負", category: "乗法" },
  { expr: "2×(−3)×(−1)×(−2)",      type: "負", category: "乗法" },
  { expr: "(−1)×3×(−1)×(−2)",      type: "負", category: "乗法" },
  { expr: "(−1)×(−1)×(−1)×2×(−1)",type: "負", category: "乗法" },
  { expr: "(−3)×(−1)×(−2)",        type: "負", category: "乗法" },
  { expr: "4×(−1)×(−1)×(−1)",      type: "負", category: "乗法" },
